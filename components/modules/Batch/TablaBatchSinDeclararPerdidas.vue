<template>
  <div>
    <v-toolbar dense class="elevation-0 carta-superior">
      <v-toolbar-title class="subheading">Elaboraciones con perdidas pendientes de declarar</v-toolbar-title>
      <v-spacer></v-spacer>
            ...
            <td class="text-xs-left">
              <div>
                ...
                <v-btn
                  ...
                  flat
                  color="orange"
                  @click="declararPerdidaBatch(props.item)"
                >
                  <v-icon>info</v-icon>
                </v-btn>
              </div>
...
import InformacionBatch from '@/components/modules/Batch/InformacionBatch'
import DeclararPerdidaBatch from '@/components/modules/Batch/DeclararPerdidaBatch'
import batch from '@/api/batch.json'
export default {
  components: {
    InformacionBatch,
    DeclararPerdidaBatch
  },
  data() {
    return {
      headers: [
